...
class NavigationTest{
    ...
    fun selectNoteAfterNavigationDrawerChange() {
        ...
        onView(withId(R.id.listItems)).perform(
            RecyclerViewActions.actionOnItemAtPosition<NoteRecyclerAdapter.NoteRecyclerViewHolder>(notePosition, click())
        )
        ...
        onView(withId(R.id.noteText)).check(matches(withText(containsString(note.text))))
    }
